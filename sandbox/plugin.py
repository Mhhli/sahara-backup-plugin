...
from sahara.plugins.sandbox import versionfactory as vhf
...
class VanillaProvider(p.ProvisioningPluginBase):
    ...
    def get_description(self):
        return _('The Sandbox plugin provides the ability to launch '
                 'upstream Hadoop and Spark cluster without any '
